...
class EncryptionPage:
    def __init__(self):
        ...
        # Поле для ввода пароля для шифрования
        self.password_field = ft.TextField(
            label="Пароль к выбранному ключу", hint_text="Введите пароль", password=True
        )

        # FilePicker для выбора файла или директории для шифрования
    ...
    def load_keys(self, e):
        # Загрузка ключей из файлов aes_keys.json и rsa_keys.json
